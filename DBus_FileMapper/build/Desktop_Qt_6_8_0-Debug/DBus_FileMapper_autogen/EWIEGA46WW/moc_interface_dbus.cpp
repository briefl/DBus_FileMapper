/****************************************************************************
** Meta object code from reading C++ file 'interface_dbus.h'
**
...
#error "The header file 'interface_dbus.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_CLASSDBusInterfaceENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDBusInterfaceENDCLASS = QtMocHelpers::stringData(
    "DBusInterface",
    "RegisterApplication",
    "",
    "appName",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDBusInterfaceENDCLASS[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       7,    2,   58,    2, 0x02,    6 /* Public */,
      10,    1,   63,    2, 0x02,    9 /* Public */,
      12,    0,   66,    2, 0x02,   11 /* Public */,
      13,    0,   67,    2, 0x02,   12 /* Public */,
...
Q_CONSTINIT const QMetaObject DBusInterface::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CLASSDBusInterfaceENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDBusInterfaceENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDBusInterfaceENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DBusInterface, std::true_type>,
...
void *DBusInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDBusInterfaceENDCLASS.stringdata0))
